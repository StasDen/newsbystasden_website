...
class __TwigTemplate_ceaecf3d2046f30a427477217afefbc1 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 30, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap/templates/input/input--button.html.twig", "/home/u535130821/domains/newsbystasden.site/public_html/themes/contrib/bootstrap/templates/input/input--button.html.twig");
    }
