...
/**
 * @file
 * Drupal site-specific configuration file.j
 *
 * IMPORTANT NOTE:
 ...
 * @endcode
 */
$settings['hash_salt'] = 'e4H0ISFAZv3L6b2iIY6EVAiY2Rp71OGuNlmYqI0q2mQGtzhnfWksFRkXBmwI1Cq3DPLcq50WdA';
...
$settings['trusted_host_patterns'] = ['^newsbystasden\.site$'];

// $settings['trusted_host_patterns'] = ['^google\.come$'];  // This is for pruduction mode

// $settings['trusted_host_patterns'] = ['^.+\.google\.come$'];  // This is for pruduction mode sub domain
...
$databases['default']['default'] = array (
  'database' => 'u535130821_drupal',
  'username' => 'u535130821_root',
  'password' => 'hostinger_Drupal_db_pas8',
  'prefix' => '',
  'host' => 'localhost',
  'port' => '',
...
$settings['config_sync_directory'] = 'sites/default/files/config_mgq6lsmLl6BRYYhGj6TzJOaG6MWu9U9Mp8H_wGomzUV4JrntQtQE5vpsLhA1TVYeiyxkB7Z1Dg/sync';
